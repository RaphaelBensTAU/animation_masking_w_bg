...
class Logger:
    def __init__(self, log_dir, checkpoint_freq=100, visualizer_params=None, zfill_num=8, log_file_name='log.txt'):
        ...
        self.visualizations_dir = os.path.join(log_dir, 'train-vis-bg')
    ...
    @staticmethod
    def load_cpk(checkpoint_path, generator=None, mask_generator=None, optimizer_generator=None, optimizer_mask_generator=None,bg_generator = None, bg_generator_optimizer = None, bg_hd = None, bg_hd_optimizer = None):
        ...
        if bg_hd is not None:
            bg_hd.load_state_dict(checkpoint['bg_refiner'])
        if bg_hd_optimizer is not None:
            bg_hd_optimizer.load_state_dict(checkpoint['optimizer_bg_refiner'])
            
        if bg_generator is not None:
            bg_generator.load_state_dict(checkpoint['bg_generator'])
        if bg_generator_optimizer is not None:
            bg_generator_optimizer.load_state_dict(checkpoint['optimizer_bg_generator'])
