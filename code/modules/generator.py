...
class Generator(nn.Module):
    ...
    def animate(self, source_image, driving_image, mask_driving, mask_source):
        ...
        print('driving_mask {}'.format(driving_mask))
        print('driving_mask_dist {}'.format(driving_mask_dist))
        print('source_mask {}'.format(source_mask))
        print('fixed_mask {}'.format(fixed_mask))
