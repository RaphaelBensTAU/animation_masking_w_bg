...
class Generator(nn.Module):
    ...
    def forward(self, source_image, driving_image, mask_driving, mask_source, mask_driving2, predict_mask, animate):
        ...
        output_dict['source_mask_64'] = source_mask_int
        output_dict['driving_mask_64'] = driving_mask_int

        e_h, e_w = driving_mask_int.shape[2:]
        s_i = F.interpolate(source_image, size=(e_h, e_w), mode='bilinear')
        d_i = F.interpolate(driving_image, size=(e_h, e_w), mode='bilinear')
        ...
        output_dict['source_64'] = s_i
        output_dict['driving_64'] = d_i
        output_dict['source_mask_256'] = source_mask_int
        output_dict['driving_mask_256'] = driving_mask_int
    ...
    def animate(self, source_image, driving_image, mask_driving, mask_source):
        ...
        output_dict['fixed_mask_64'] = fixed_mask
